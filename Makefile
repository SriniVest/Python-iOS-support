...
dist/Python.framework/Python: build/python/ios-armv7/Python build/python/ios-armv7s/Python build/python/ios-arm64/Python build/python/ios-simulator/Python build/rubicon-objc-$(RUBICON_VERSION)
	...
	cp build/python/ios-armv7s/include/python$(basename $(PYTHON_VERSION))/pyconfig.h dist/Python.framework/Versions/$(basename $(PYTHON_VERSION))/Resources/include/python$(basename $(PYTHON_VERSION))/pyconfig-armv7s.h
